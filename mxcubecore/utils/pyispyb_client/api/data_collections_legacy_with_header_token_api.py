...
class DataCollectionsLegacyWithHeaderTokenApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.get_endpoint = _Endpoint(
            settings={
                ...
                'endpoint_path': '/ispyb/api/v1/data_collections/groups/session/{session_id}',
                'operation_id': 'get',
                'http_method': 'GET',
                'servers': None,
            },
    ...
    def get(
        ...
        **kwargs
        ...
        >>> thread = api.get(session_id, async_req=True)
        >>> result = thread.get()
