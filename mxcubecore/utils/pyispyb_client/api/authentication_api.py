...
class AuthenticationApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.login_ispyb_api_v1_auth_login_post_endpoint = _Endpoint(
            settings={
                'response_type': (TokenResponse,),
                'auth': [],
                'endpoint_path': '/ispyb/api/v1/auth/login',
                'operation_id': 'login_ispyb_api_v1_auth_login_post',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
    ...
    def login_ispyb_api_v1_auth_login_post(
        self,
        login,
        **kwargs
    ):
        ...
        >>> thread = api.login_ispyb_api_v1_auth_login_post(login, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['login'] = \
            login
        return self.login_ispyb_api_v1_auth_login_post_endpoint.call_with_http_info(**kwargs)
