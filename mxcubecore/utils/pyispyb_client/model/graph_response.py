...
class GraphResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, graph_id, data_collection_id, name, *args, **kwargs):  # noqa: E501
        """GraphResponse - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, graph_id, data_collection_id, name, *args, **kwargs):  # noqa: E501
        """GraphResponse - a model defined in OpenAPI
