...
class DataCollectionMetaData(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, snapshots, *args, **kwargs):  # noqa: E501
        """DataCollectionMetaData - a model defined in OpenAPI
