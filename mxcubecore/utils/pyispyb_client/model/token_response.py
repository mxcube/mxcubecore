...
class TokenResponse(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, username, token, permissions, groups, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, username, token, permissions, groups, *args, **kwargs):  # noqa: E501
        """TokenResponse - a model defined in OpenAPI
