...
class Event(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, type, count, item, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            bl_sample (str): Sample name. [optional]  # noqa: E501
            bl_sample_id (int): Sample id. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, type, count, item, *args, **kwargs):  # noqa: E501
        """Event - a model defined in OpenAPI
