...
class Sample(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'metadata': (SampleMetaData,),  # noqa: E501
            'bl_sample_id': (int,),  # noqa: E501
            'crystal': (Crystal,),  # noqa: E501
            'comments': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, metadata, bl_sample_id, crystal, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            comments (bool, date, datetime, dict, float, int, list, str, none_type): [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, metadata, bl_sample_id, crystal, *args, **kwargs):  # noqa: E501
        """Sample - a model defined in OpenAPI
