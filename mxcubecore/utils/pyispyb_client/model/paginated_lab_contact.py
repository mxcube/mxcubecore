...
class PaginatedLabContact(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, total, results, skip, limit, *args, **kwargs):  # noqa: E501
        """PaginatedLabContact - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, total, results, skip, limit, *args, **kwargs):  # noqa: E501
        """PaginatedLabContact - a model defined in OpenAPI
