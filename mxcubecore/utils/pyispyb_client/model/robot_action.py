...
class RobotAction(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, action_type, *args, **kwargs):  # noqa: E501
        """RobotAction - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, action_type, *args, **kwargs):  # noqa: E501
        """RobotAction - a model defined in OpenAPI
