...
class SSXDataCollectionCreate(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'sequences': ([SSXSequenceCreate],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, session_id, data_collection_group_id, start_time, sequences, *args, **kwargs):  # noqa: E501
        """SSXDataCollectionCreate - a model defined in OpenAPI

        Args:
            session_id (int):
            data_collection_group_id (int):
            start_time (datetime):
            sequences ([SSXSequenceCreate]):
    ...
    @convert_js_args_to_python_args
    def __init__(self, session_id, data_collection_group_id, start_time, sequences, *args, **kwargs):  # noqa: E501
        """SSXDataCollectionCreate - a model defined in OpenAPI
