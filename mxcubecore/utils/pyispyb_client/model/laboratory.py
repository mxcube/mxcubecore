...
class Laboratory(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, address, city, postcode, country, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, address, city, postcode, country, *args, **kwargs):  # noqa: E501
        """Laboratory - a model defined in OpenAPI
