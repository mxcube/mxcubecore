...
class DataCollection(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'data_collection_group': (PyispybCoreSchemasEventsDataCollectionGroup,),  # noqa: E501
            'metadata': (DataCollectionMetaData,),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data_collection_group, metadata, *args, **kwargs):  # noqa: E501
        """DataCollection - a model defined in OpenAPI

        Args:
            data_collection_group (PyispybCoreSchemasEventsDataCollectionGroup):
    ...
    @convert_js_args_to_python_args
    def __init__(self, data_collection_group, metadata, *args, **kwargs):  # noqa: E501
        """DataCollection - a model defined in OpenAPI
