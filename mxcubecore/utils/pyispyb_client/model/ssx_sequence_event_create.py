...
class SSXSequenceEventCreate(ModelNormal):
    ...
    allowed_values = {
        ('type',): {
            'XRAYDETECTION': "XrayDetection",
            'XRAYEXPOSURE': "XrayExposure",
            'LASEREXCITATION': "LaserExcitation",
    ...
    def _from_openapi_data(cls, type, time, *args, **kwargs):  # noqa: E501
        """SSXSequenceEventCreate - a model defined in OpenAPI
