...
class PyispybCoreSchemasEventsDataCollectionGroup(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, data_collection_group_id, experiment_type, *args, **kwargs):  # noqa: E501
        """PyispybCoreSchemasEventsDataCollectionGroup - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, data_collection_group_id, experiment_type, *args, **kwargs):  # noqa: E501
        """PyispybCoreSchemasEventsDataCollectionGroup - a model defined in OpenAPI
