...
mxcubeqt) for one or more configuration directories.
...
mxcubeweb does not need its own "<root>/mxcube-web" listed explicitly: the
web server finds it on its own (see the note on build_lookup_path below).
