...
from mxcubecore.hardware_objects.abstract.AbstractOnlineProcessing import (
    AbstractOnlineProcessing,
)

from mxcubecore.hardware_objects.XSDataCommon import (
    XSDataBoolean,
    XSDataDouble,
    XSDataInteger,
    XSDataString,
)
from mxcubecore.hardware_objects.XSDataControlDozorv1_1 import (
