...
class Lima2Detector(AbstractDetector):
    ...
    def init(self):
        ...
        _logger.info(f"Initializing Lima2Detector: {lima_ctrl_device} {lima_recv_devices}")
    ...
    def prepare_acquisition(
        ...
        def get_dense_out_params(variant_name):
            ...
            variant_data = {
                "legacy": dict(pixel_type="int32",
                               photon_adus=legacy_photon_adus,
                               photon_bias=0.0),
                "0":      dict(pixel_type="int16",
                               photon_adus=16.0,
                               photon_bias=0.0),
                "1":      dict(pixel_type="uint16",
                               photon_adus=16.0,
                               photon_bias=32.0),
                 "2":      dict(pixel_type="uint16",
                               photon_adus=8.0,
                               photon_bias=32.0),
                 "3":      dict(pixel_type="int16",
                               photon_adus=8.0,
                               photon_bias=0.0),
            }
