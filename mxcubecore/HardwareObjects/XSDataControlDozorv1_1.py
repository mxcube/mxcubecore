...
class XSDataControlImageDozor(object):
    def __init__(self, score=None, powder_wilson_rfactor=None, powder_wilson_correlation=None, powder_wilson_resolution=None, powder_wilson_bfactor=None, powder_wilson_scale=None, spots_resolution=None, spots_int_aver=None, spots_num_of=None, number=None, image=None):
        if image is None:
            self._image = None
...
class XSDataInputControlDozor(XSDataInput):
    def __init__(self, configuration=None, beamstopDistance=None, beamstopSize=None, beamstopDirection=None, pixelMax=None, pixelMin=None, reversing_rotation=None, line_number_of=None, last_run_number=None, first_run_number=None, last_image_number=None, first_image_number=None, template=None):
        ...
        if first_image_number is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor constructor argument 'first_image_number' is not XSDataInteger but %s" % self._first_image_number.__class__.__name__
            raise BaseException(strMessage)
        if last_image_number is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor constructor argument 'last_image_number' is not XSDataInteger but %s" % self._last_image_number.__class__.__name__
            raise BaseException(strMessage)
        if first_run_number is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor constructor argument 'first_run_number' is not XSDataInteger but %s" % self._first_run_number.__class__.__name__
            raise BaseException(strMessage)
        if last_run_number is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor constructor argument 'last_run_number' is not XSDataInteger but %s" % self._last_run_number.__class__.__name__
            raise BaseException(strMessage)
        if line_number_of is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor constructor argument 'line_number_of' is not XSDataInteger but %s" % self._line_number_of.__class__.__name__
            raise BaseException(strMessage)
        if reversing_rotation is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor constructor argument 'reversing_rotation' is not XSDataBoolean but %s" % self._reversing_rotation.__class__.__name__
            raise BaseException(strMessage)
        if pixelMin is None:
            self._pixelMin = None
            ...
            strMessage = "ERROR! XSDataInputControlDozor constructor argument 'pixelMin' is not XSDataInteger but %s" % self._pixelMin.__class__.__name__
            raise BaseException(strMessage)
        if pixelMax is None:
            self._pixelMax = None
            ...
            strMessage = "ERROR! XSDataInputControlDozor constructor argument 'pixelMax' is not XSDataInteger but %s" % self._pixelMax.__class__.__name__
            raise BaseException(strMessage)
        if beamstopDirection is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor constructor argument 'beamstopDirection' is not XSDataString but %s" % self._beamstopDirection.__class__.__name__
            raise BaseException(strMessage)
        if beamstopSize is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor constructor argument 'beamstopSize' is not XSDataDouble but %s" % self._beamstopSize.__class__.__name__
            raise BaseException(strMessage)
        if beamstopDistance is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor constructor argument 'beamstopDistance' is not XSDataDouble but %s" % self._beamstopDistance.__class__.__name__
            raise BaseException(strMessage)
    ...
    def getFirst_image_number(self): return self._first_image_number
    def setFirst_image_number(self, first_image_number):
        if first_image_number is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor.setFirst_image_number argument is not XSDataInteger but %s" % first_image_number.__class__.__name__
            raise BaseException(strMessage)
    def delFirst_image_number(self): self._first_image_number = None
    first_image_number = property(getFirst_image_number, setFirst_image_number, delFirst_image_number, "Property for first_image_number")
    # Methods and properties for the 'last_image_number' attribute
    def getLast_image_number(self): return self._last_image_number
    def setLast_image_number(self, last_image_number):
        if last_image_number is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor.setLast_image_number argument is not XSDataInteger but %s" % last_image_number.__class__.__name__
            raise BaseException(strMessage)
    def delLast_image_number(self): self._last_image_number = None
    last_image_number = property(getLast_image_number, setLast_image_number, delLast_image_number, "Property for last_image_number")
    # Methods and properties for the 'first_run_number' attribute
    def getFirst_run_number(self): return self._first_run_number
    def setFirst_run_number(self, first_run_number):
        if first_run_number is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor.setFirst_run_number argument is not XSDataInteger but %s" % first_run_number.__class__.__name__
            raise BaseException(strMessage)
    def delFirst_run_number(self): self._first_run_number = None
    first_run_number = property(getFirst_run_number, setFirst_run_number, delFirst_run_number, "Property for first_run_number")
    # Methods and properties for the 'last_run_number' attribute
    def getLast_run_number(self): return self._last_run_number
    def setLast_run_number(self, last_run_number):
        if last_run_number is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor.setLast_run_number argument is not XSDataInteger but %s" % last_run_number.__class__.__name__
            raise BaseException(strMessage)
    def delLast_run_number(self): self._last_run_number = None
    last_run_number = property(getLast_run_number, setLast_run_number, delLast_run_number, "Property for last_run_number")
    # Methods and properties for the 'line_number_of' attribute
    def getLine_number_of(self): return self._line_number_of
    def setLine_number_of(self, line_number_of):
        if line_number_of is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor.setLine_number_of argument is not XSDataInteger but %s" % line_number_of.__class__.__name__
            raise BaseException(strMessage)
    def delLine_number_of(self): self._line_number_of = None
    line_number_of = property(getLine_number_of, setLine_number_of, delLine_number_of, "Property for line_number_of")
    # Methods and properties for the 'reversing_rotation' attribute
    def getReversing_rotation(self): return self._reversing_rotation
    def setReversing_rotation(self, reversing_rotation):
        if reversing_rotation is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor.setReversing_rotation argument is not XSDataBoolean but %s" % reversing_rotation.__class__.__name__
            raise BaseException(strMessage)
    def delReversing_rotation(self): self._reversing_rotation = None
    reversing_rotation = property(getReversing_rotation, setReversing_rotation, delReversing_rotation, "Property for reversing_rotation")
    ...
    def setPixelMin(self, pixelMin):
        if pixelMin is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor.setPixelMin argument is not XSDataInteger but %s" % pixelMin.__class__.__name__
            raise BaseException(strMessage)
    ...
    def setPixelMax(self, pixelMax):
        if pixelMax is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor.setPixelMax argument is not XSDataInteger but %s" % pixelMax.__class__.__name__
            raise BaseException(strMessage)
    ...
    def getBeamstopDirection(self): return self._beamstopDirection
    def setBeamstopDirection(self, beamstopDirection):
        if beamstopDirection is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor.setBeamstopDirection argument is not XSDataString but %s" % beamstopDirection.__class__.__name__
            raise BaseException(strMessage)
    def delBeamstopDirection(self): self._beamstopDirection = None
    beamstopDirection = property(getBeamstopDirection, setBeamstopDirection, delBeamstopDirection, "Property for beamstopDirection")
    # Methods and properties for the 'beamstopSize' attribute
    def getBeamstopSize(self): return self._beamstopSize
    def setBeamstopSize(self, beamstopSize):
        if beamstopSize is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor.setBeamstopSize argument is not XSDataDouble but %s" % beamstopSize.__class__.__name__
            raise BaseException(strMessage)
    def delBeamstopSize(self): self._beamstopSize = None
    beamstopSize = property(getBeamstopSize, setBeamstopSize, delBeamstopSize, "Property for beamstopSize")
    # Methods and properties for the 'beamstopDistance' attribute
    def getBeamstopDistance(self): return self._beamstopDistance
    def setBeamstopDistance(self, beamstopDistance):
        if beamstopDistance is None:
            ...
            strMessage = "ERROR! XSDataInputControlDozor.setBeamstopDistance argument is not XSDataDouble but %s" % beamstopDistance.__class__.__name__
            raise BaseException(strMessage)
    def delBeamstopDistance(self): self._beamstopDistance = None
