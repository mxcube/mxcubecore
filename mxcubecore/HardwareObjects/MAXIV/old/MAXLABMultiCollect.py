        ...
        for input_file_dir, file_prefix in (
            ...
            try:
                valdict = {
                    ...
                    "I911-collection_start_time": time.strftime(
                        "%Y-%m-%d %H:%M:%S"
                    ),  # just a hack for now (2013-09-09) should be taken from the lims system in AbstractMultiCollect.py, so we are certain it's the same
