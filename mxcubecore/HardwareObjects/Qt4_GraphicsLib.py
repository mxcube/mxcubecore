...
class GraphicsItemInfo(GraphicsItem):
    ...
    def paint(self, painter, option, widget):
        ...
        if self.__msg:
            ...
            self.custom_pen.setColor(QtCore.Qt.black)
            painter.setPen(self.custom_pen)
    ...
    def display_info(self, msg, pos_x, pos_y, hide_msg=True):
        ...
        if type(msg) == str:
            ...
            height = 20 * len(msg)
        height += 10
        self.__draw_rect = QtCore.QRectF(pos_x, pos_y,
...
class GraphicsItemGrid(GraphicsItem):
    ...
    def update_item(self):
        self.__cell_size_mm = [self.beam_size_mm[0] + self.__spacing_mm[0] * 2,
                               self.beam_size_mm[1] + self.__spacing_mm[1] * 2]
    ...
    def set_centred_position(self, centred_position):
        ...
        """
        self.__overlay_pixmap = QtGui.QGraphicsPixmapItem(self)
        #self.scene().addItem(self.__overlay_pixmap)
        qpixmap = QtGui.QPixmap("/tmp/smoth_result_smoth.png")
...
class GraphicsItemScale(GraphicsItem):
    ...
    def paint(self, painter, option, widget):
        ...
        if self.__display_grid:
            ...
            self.custom_pen.setStyle(QtCore.Qt.DashLine)
            self.custom_pen.setWidth(1)
            self.custom_pen.setColor(QtCore.Qt.yellow)
            painter.setPen(self.custom_pen)
...
class GraphicsItemCentringLines(GraphicsItem):
    ...
    def paint(self, painter, option, widget):
        ...
        for centring_point in self.centring_points:
            painter.drawLine(centring_point[0] - 3, centring_point[1] - 3,
                             centring_point[0] + 3, centring_point[1] + 3)
            painter.drawLine(centring_point[0] - 3, centring_point[1] + 3,
                             centring_point[0] + 3, centring_point[1] - 3)
...
class GraphicsItemMove(GraphicsItem):
    """
    Descrip. : 
    """
    ...
    def __init__(self, parent, direction):
        ...
        self.arrow_polygon = QtGui.QPolygon(self)
        self.set_size(20, 20)
        ...
        for point in points:
            self.arrow_polygon.append(QtCore.QPoint(*point))
    ...
    def paint(self, painter, option, widget):
        ...
        painter.drawPolygon(self.arrow_polygon, QtCore.Qt.OddEvenFill)
        if self.item_hover:
            self.custom_brush.setColor(NORMAL_COLOR)
        else:
            self.custom_brush.setColor(QtGui.QColor(70, 70, 165, 40))
        painter.drawPolygon(self.arrow_polygon, QtCore.Qt.OddEvenFill)
...
class GraphicsScene(QtGui.QGraphicsScene):
    ...
    moveItemClickedSignal = QtCore.pyqtSignal(str)
