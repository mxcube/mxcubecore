...
e.g. class MotorMockup(MockActuator, AbstractMotor):
"""
...
class MockActuator(AbstractActuator.AbstractActuator):
    """Mock Motor implementation"""

    def __init__(self, name):
        super(MockActuator, self).__init__(name)
        self.__move_task = None

    def init(self):
        """ Initialisation method """
        super(MockActuator, self).init()
