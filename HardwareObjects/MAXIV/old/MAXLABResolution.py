...
class MAXLABResolution(BaseHardwareObjects.Equipment):
    def _init(self):
    ...
    def init(self):
        ...
        self.detector_diameter_chan = self.addChannel(
            {
                "type": "spec",
                "version": self.getradius.specVersion,
        ...
        self.beam_centre_channel = self.addChannel(
            {
                "type": "spec",
                "version": self.getradius.specVersion,
                "name": "beam_centre",
    ...
    def beam_centre_updated(self, beam_pos_dict):
        ...
        self.det_radius = min(
            self.detector_diameter - x, self.detector_diameter - y, x, y
        )
